...
public class mcql2 extends AppCompatActivity {
...
//    }
    ...
    private void showSubmitConfirmationDialog() {
        ...
        Dialog dialog = new Dialog(mcql2.this);
        ...
        yesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                calculateScore();
                Intent intent = new Intent(mcql2.this, Result.class);
...
//    }
    ...
    public void onBackPressed() {        // Override onBackPressed to handle back navigation
        ...
        yesButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(mcql2.this, HomeActivity.class);
